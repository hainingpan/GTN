...
# normal script (legacy)
srun singularity exec --nv /scratch/hp636/pytorch.sif python run_classA_2D_EE_ave.py --L $L --nshell $nshell --mu $mu --es 300 --sigma $sigma --seed0 0
